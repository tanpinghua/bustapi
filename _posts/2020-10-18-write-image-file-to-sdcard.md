...
Choose the download according to the operating system that you will use to write the image file. 
...
The write process should start after that.
...
In my case it tooks around 15 minutes to complete, but it depends on the internet speed and the SDCard write speed. The full image file will be automatically downloaded from the internet before the write process begin. 
